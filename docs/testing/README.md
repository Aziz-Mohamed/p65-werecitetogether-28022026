...
This directory contains systematic testing documentation for WeReciteTogether. It covers the 5 active user roles, their permissions, and step-by-step test scripts.

> **Note:** The **Parent** and **Admin (School)** roles are deferred for MVP. Parent data is stored on the student account (guardian contact fields). The school admin functionality has been absorbed into the **Master Admin** role (CRUD for students, teachers, classes, stickers, etc.).
...
3. **Classes**: At least 1 class per program (one with capacity, one full for waitlist testing)
4. **Program Roles**: Assign the teacher, supervisor, and program_admin test accounts to the programs:
   ...
   ```
5. **Enrollments**: Enroll the student in at least 1 class
